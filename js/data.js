...
export const ENEMIES = {
  ...
  treasure_goblin: {
    ...
    gold: 20,
    dropChance: 1,
    dropPool: ["golden_idol", "gold_nugget", "gold_nugget"],
    cost: 3,
    behavior: "fleer",
    fleeTimer: 8,
  },
...
export const ENEMY_POOL_BY_LEVEL = {
  1: ["green_blob", "green_blob", "skeleton", "rat_swarm", "killer_bee"],
  2: ["green_blob", "skeleton", "fire_imp", "rat_swarm", "killer_bee", "treasure_goblin"],
